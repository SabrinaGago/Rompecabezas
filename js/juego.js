...
var instrucciones = ["Utilizá las fechas para mover las piezas","Ordená las piezas hasta alcanzar la imagen objetivo"];

// Arreglo para ir guardando los movimientos que se vayan realizando, DEJAR VACIO
var movimientos = [];
...
function mostrarCartelGanador() {
  alert("¡Lo lograste! Ganaste el juego.");
  var pregunta = prompt("¿Queres jugar nuevamente? \n1. Si \n2. No");
  switch (pregunta) {
    case "1":
    mezclarPiezas(30);
    break;
